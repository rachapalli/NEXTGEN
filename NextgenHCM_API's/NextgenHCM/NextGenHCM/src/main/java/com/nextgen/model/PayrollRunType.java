...
@Entity
@Table(name = "payroll_run_type")
public class PayrollRunType implements java.io.Serializable {
	 ...
	 * @param name
	 */
	public PayrollRunType(Long id, String type) {
